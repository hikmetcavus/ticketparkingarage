...
import net.hikmetcavus.garage.model.resp.NoContentResponse;
import net.hikmetcavus.garage.model.resp.OkResponse;
import net.hikmetcavus.garage.resources.garage.model.VehicleInput;
import net.hikmetcavus.garage.resources.garage.mapper.VehicleMapper;
import net.hikmetcavus.garage.service.garage.model.Slot;
import net.hikmetcavus.garage.service.garage.model.Ticket;
