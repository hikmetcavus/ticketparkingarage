package net.hikmetcavus.garage.resources;

import lombok.extern.slf4j.Slf4j;
import net.hikmetcavus.garage.model.resp.BadRequestResponse;
import net.hikmetcavus.garage.model.resp.GarageResponse;
import net.hikmetcavus.garage.model.resp.ResponseError;
import net.hikmetcavus.garage.model.resp.ServerErrorResponse;
